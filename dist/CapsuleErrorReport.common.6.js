...
// EXTERNAL MODULE: ./node_modules/capsule-editor/src/Editor.vue + 182 modules
...
index_es["c" /* library */].add(free_solid_svg_icons_index_es["o" /* faRedo */]);
index_es["c" /* library */].add(free_solid_svg_icons_index_es["f" /* faEnvelope */]);
index_es["c" /* library */].add(free_solid_svg_icons_index_es["e" /* faDownload */]);
index_es["c" /* library */].add(free_solid_svg_icons_index_es["c" /* faCheckCircle */]);
index_es["c" /* library */].add(free_regular_svg_icons_index_es["a" /* faFileArchive */]);
index_es["c" /* library */].add(free_solid_svg_icons_index_es["p" /* faTimesCircle */]);
index_es["c" /* library */].add(free_solid_svg_icons_index_es["r" /* faWindowClose */]);
